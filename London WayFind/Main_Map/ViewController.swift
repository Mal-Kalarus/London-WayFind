...
class ViewController: UIViewController, UITextFieldDelegate, MKMapViewDelegate, UISearchBarDelegate {
    ...
    @IBAction func showRoute1Map() {
        NearbyRoute1.backgroundColor = UIColor.init(red: 52/255, green: 151/255, blue: 253/255, alpha: 1)
        arModeButton.isHidden = true
    ...
    @IBAction func searchView(){

        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let mainViewController = storyBoard.instantiateViewController(withIdentifier: "SearchController") as! UINavigationController
    ...
    @IBAction func goToAlerts() {
        ...
        let mainViewController = storyBoard.instantiateViewController(withIdentifier: "NotificationsViewController") as! NotificationsViewController
        self.present(mainViewController, animated: false, completion: nil)
    }
